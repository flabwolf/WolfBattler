            ...
            .done(function (data) {
                ...
                data.forEach(function (room_info) {
                    if (room_info[3] >= 5) {
                        ...
                        $(".join_room").append("<div class='content'><h3 class='room_name'>" + room_info[1] + "</h3>" + "<h4 class='player_num'>" + "現在：" + room_info[3] + "人</h4>" + "<button class='enter_room_btn btn' disabled>参加</button></div>").trigger("create");
                    }
                    else {
                        $(".join_room").append("<div class='card'><div class='card-body'><div class='content'><h3 class='room_name'>" + room_info[1] + "</h3>" + "<h4 class='player_num'>" + "現在：" + room_info[3] + "人</h4>" + "<button class='enter_room_btn btn-danger btn'>参加</button></div></div></div>").trigger("create");
                    }
                });
            })
            .fail(function () {
